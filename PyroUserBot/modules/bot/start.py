from PyroUserbot import app, API_ID, API_HASH
...
async def clone(bot: app, msg: Message):
    ...
    try:
        ...
        client = Client(name="Melody", api_id=API_ID, api_hash=API_HASH, session_string=phone, plugins=dict(root= PyroUserbot/modules"))
        await client.start()
