...
from PyroUserBot import START_TIME
from PyroUserBot import SUDO_USER
from PyroUserBot.helper.PyroHelpers import ReplyCheck
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **ꜱᴜᴘᴘᴏʀᴛ**: [Click](t.me/PyroUserBotS)\n"
        f"├• **ᴄʜᴀɴɴᴇʟ**: [Click](t.me/PyroUserBotS)\n"
        f"└• **ʀᴇᴘᴏ**: [Click](https://GitHub.com/PyroUserBot/PyroUserBot)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://github.com/PyroUserBot/PyroUserBot\nFork & Give an ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://gitHub.com/PyroUserBot")
